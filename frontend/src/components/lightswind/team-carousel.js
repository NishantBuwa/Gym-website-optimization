...
export const TeamCarousel = ({ members, title = "", titleSize = "xl", titleColor = "rgba(0, 76, 255, 1)", background, cardWidth = 280, cardHeight = 380, cardRadius =25, showArrows = true, showDots = true, keyboardNavigation = true, touchNavigation = true, animationDuration = 800, autoPlay = 0, pauseOnHover = true, visibleCards = 2, sideCardScale = 0.9, sideCardOpacity = 0.8, grayscaleEffect = true, className, cardClassName, titleClassName, infoPosition = "bottom", infoTextColor = "white", infoBackground = "transparent", onMemberChange, onCardClick, initialIndex = 0, }) => {
    ...
    return (_jsxs("div", { id: "team-carousel-container", className: cn(`mt-64 sm:mt-0 sm:h-[700px] h-auto lg:min-h-screen flex flex-col items-center justify-center overflow-hidden text-white
        `, className), style: { background: background }, onTouchStart: handleTouchStart, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd, children: [title && (_jsx("h1", { className: cn("font-black uppercase tracking-tight absolute top-12 bottom-4 left-1/2 transform -translate-x-1/2 pointer-events-none whitespace-nowrap", titleSizeClasses[titleSize], titleClassName), style: {
                    ...
                    backgroundClip: 'text',
                }, children: title })), _jsxs("div", { className: "w-full max-w-6xl relative ", style: {
                    height: cardHeight + 100,
                    perspective: '1000px',
                }, children: [showArrows && (_jsxs(_Fragment, { children: [_jsx(motion.button, { onClick: () => paginate(-1),"aria-label":"Previous slide", className: "mt-20 absolute left-5 top-1/2 transform -translate-y-1/2 bg-black/60 hover:bg-black/80 text-white w-10 h-10 rounded-full flex items-center justify-center z-20 transition-all duration-300 hover:scale-110", whileTap: { scale: 0.9 }, children: _jsx(ChevronLeft, { className: "w-6 h-6" }) }), _jsx(motion.button, { onClick: () => paginate(1),"aria-label":"Next Slide", className: "mt-20 absolute right-5 top-1/2 transform -translate-y-1/2 bg-black/60 hover:bg-black/80 text-white w-10 h-10 rounded-full flex items-center justify-center z-20 transition-all duration-300 hover:scale-110", whileTap: { scale: 0.9 }, children: _jsx(ChevronRight, { className: "w-6 h-6" }) })] })), _jsx("div", { className: "mt-20  w-full h-full flex justify-center items-center relative", style: { transformStyle: 'preserve-3d' }, children: _jsx(AnimatePresence, { initial: false, custom: direction, children: members.map((member, index) => {
                                ...
                                return (_jsxs(motion.div, { className: cn(" absolute bg-white overflow-hidden shadow-2xl cursor-pointer", cardClassName), style: {
                                    ...
                                    }, children: [_jsx("img", { src: member.image, alt: member.name, className: "w-full h-full object-cover",loading:'lazy' }), infoPosition === 'overlay' && (_jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-4 text-center", style: {
                            ...
                            }) }) })] }), infoPosition === 'bottom' && members[currentIndex] && (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -20 }, transition: { duration: 0.3 }, className: "text-center mt-20", children: [_jsxs("h2", { className: "text-4xl font-bold mb-3 relative inline-block", style: { color: 'white' }, children: [members[currentIndex].name, _jsx("span", { className: "absolute top-full left-0 w-full h-0.5 mt-2", style: { background: 'white' } })] }), _jsx("p", { className: "text-xl font-medium uppercase tracking-wider", style: { color: 'white' }, children: members[currentIndex].role }), members[currentIndex].bio && (_jsx("p", { className: "text-[18px] mt-4 max-w-lg mx-auto ", children: members[currentIndex].bio }))] }, members[currentIndex].id + "-info")), showDots && (_jsx("div", { className: "flex justify-center gap-3 mt-15 ", children: members.map((_, index) => (_jsx(motion.button, { onClick: () => {
                    ...
                    className: cn("mt-3 mb-0 w-3 h-3 rounded-full transition-all duration-300", index === currentIndex
                        ? "scale-125"
