...
export const Compare = ({
    ...
    // 🟢 Add this new effect to handle mobile touchend
    useEffect(() => {
        const handleGlobalTouchEnd = () => {
            if (slideMode === "drag") {
                setIsDragging(false);
                setSliderXPercent(initialSliderPercentage); // reset to middle
            }
        };
                ...
                {secondImage ? (
                    <motion.div
                        ...
                        <img
                            ...
                            loading="lazy"
                            className={cn(
                                "absolute inset-0 z-10 rounded-2xl shrink-0 w-full h-full select-none",
                                secondImageClassname
                            )}
                            draggable={false}
                        />
